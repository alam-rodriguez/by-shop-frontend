...
const page = () => {
    ...
    const { data, isLoading, refetch } = useGetDeliveryOrderById(id);
    ...
    return (
        <div className="m-4 flex flex-col gap-4">
            <p className="text-center font-bold text-xl">Orden seleccionada</p>
            {/* {data.map((delivery) => ( */}
            ...
            <div className="flex flex-col gap-4">
                ...
                <Spacer />
                {data.status != 2 && data.id_delivery && data.id_delivery == idUser && (
