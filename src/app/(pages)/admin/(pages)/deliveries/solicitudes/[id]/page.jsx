...
import { getDeliveryApplication, getDeliveryApplicationByApplicationId } from "@/app/hooks/request/applications/requestsDeliveriesApplications";
import deliveryApplicationSchema from "@/app/schemas/deliveryApplication.schema";

const page = () => {
    const { id: applicationId } = useParams();

    const wantCreate = applicationId == 0 ? true : false;
    ...
    // const { data, isLoading } = useGetCurrencyById(applicationId);
    const { data, isLoading } = getDeliveryApplicationByApplicationId(applicationId);
