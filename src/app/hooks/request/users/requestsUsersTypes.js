...
// Requests
import { createUserType, fetchGetUserTypeByName, getUsersTypes } from "@/app/request/users/requestsUsersTypes";
...
export const getUserTypeByName = async (name) => {
    const { message, status, data } = await fetchGetUserTypeByName(name);
    return data;
};
